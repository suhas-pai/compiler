...
namespace Sema {
    ...
    public:
        ...
        [[nodiscard]] static auto f8() noexcept -> BuiltinType & {
            static auto Result = BuiltinType("f8");
            return Result;
        }

        [[nodiscard]] static auto f16() noexcept -> BuiltinType & {
            static auto Result = BuiltinType("f16");
            return Result;
        }
